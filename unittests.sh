...
"./sparse_matrix.bin --tr -f int64.in --format CSR -s -t 4"
"./sparse_matrix.bin --tr -f int64.in --format CSR -s --nothreading"
"./sparse_matrix.bin --tr -f float64.in --format CSR -s -t 4"
"./sparse_matrix.bin --tr -f float64.in --format CSR -s --nothreading"
"./sparse_matrix.bin --tr -f int64.in --format CSC -s -t 4"
"./sparse_matrix.bin --tr -f int64.in --format CSC -s --nothreading"
"./sparse_matrix.bin --tr -f float64.in --format CSC -s -t 4"
"./sparse_matrix.bin --tr -f float64.in --format CSC -s --nothreading"
#transpose tests
